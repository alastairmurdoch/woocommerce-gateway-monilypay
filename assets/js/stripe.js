...
jQuery( function( $ ) {
	...
	var wc_stripe_form = {
		...
		isStripeChosen: function() {
			return $( '#payment_method_monilypay, #payment_method_stripe_bancontact, #payment_method_stripe_sofort, #payment_method_stripe_giropay, #payment_method_stripe_ideal, #payment_method_stripe_alipay, #payment_method_stripe_sepa, #payment_method_stripe_eps, #payment_method_stripe_multibanco, #payment_method_stripe_boleto, #payment_method_stripe_oxxo' ).is( ':checked' ) || ( $( '#payment_method_stripe' ).is( ':checked' ) && 'new' === $( 'input[name="wc-monilypay-payment-token"]:checked' ).val() ) || ( $( '#payment_method_stripe_sepa' ).is( ':checked' ) && 'new' === $( 'input[name="wc-monilypay-payment-token"]:checked' ).val() );
		},
		...
		isStripeSaveCardChosen: function() {
			return (
				$( '#payment_method_monilypay' ).is( ':checked' ) &&
				$( 'input[name="wc-monilypay-payment-token"]' ).is( ':checked' ) &&
				'new' !== $( 'input[name="wc-monilypay-payment-token"]:checked' ).val()
			) || (
		...
		isStripeCardChosen: function() {
			return $( '#payment_method_monilypay' ).is( ':checked' );
		},
