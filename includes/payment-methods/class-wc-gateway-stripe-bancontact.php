 ...
 * @since 4.0.0
 */
class WC_Gateway_Monilypay_Bancontact extends WC_Monilypay_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = self::ID;
		$this->method_title       = __( 'Stripe Bancontact', 'woocommerce-gateway-monilypay' );
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_monilypay_bancontact_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_MONILYPAY_PLUGIN_PATH . '/includes/admin/stripe-bancontact-settings.php';
	}
	...
	public function create_source( $order ) {
		...
		return WC_Monilypay_API::request( apply_filters( 'wc_monilypay_bancontact_source', $post_data, $order ), 'sources' );
	}
