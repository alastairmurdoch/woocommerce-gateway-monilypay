 ...
 * @since 4.0.0
 */
class WC_Gateway_Monilypay_Giropay extends WC_Monilypay_Payment_Gateway {
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_monilypay_giropay_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_MONILYPAY_PLUGIN_PATH . '/includes/admin/stripe-giropay-settings.php';
	}
	...
	public function create_source( $order ) {
		...
		WC_Monilypay_Logger::log( 'Info: Begin creating giropay source' );

		return WC_Monilypay_API::request( apply_filters( 'wc_monilypay_giropay_source', $post_data, $order ), 'sources' );
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_Monilypay_Logger::log( 'Info: Redirecting to giropay...' );
