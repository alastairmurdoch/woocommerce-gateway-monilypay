 ...
 * @since 4.1.0
 */
class WC_Gateway_Monilypay_Eps extends WC_Monilypay_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = self::ID;
		$this->method_title       = __( 'Stripe EPS', 'woocommerce-gateway-monilypay' );
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_monilypay_eps_supported_currencies',
			[
				'EUR',
			]
		);
	...
	public function init_form_fields() {
		$this->form_fields = require WC_MONILYPAY_PLUGIN_PATH . '/includes/admin/stripe-eps-settings.php';
	}
	...
	public function create_source( $order ) {
		...
		WC_Monilypay_Logger::log( 'Info: Begin creating EPS source' );
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_Monilypay_Logger::log( 'Info: Redirecting to EPS...' );
