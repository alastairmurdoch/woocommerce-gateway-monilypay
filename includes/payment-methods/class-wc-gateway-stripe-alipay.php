...
class WC_Gateway_Monilypay_Alipay extends WC_Monilypay_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = self::ID;
		$this->method_title       = __( 'Stripe Alipay', 'woocommerce-gateway-monilypay' );
	...
	public function get_supported_currency() {
		return apply_filters(
			'wc_monilypay_alipay_supported_currencies',
			[
				'EUR',
				'AUD',
				'CAD',
	...
	public function init_form_fields() {
		$this->form_fields = require WC_MONILYPAY_PLUGIN_PATH . '/includes/admin/stripe-alipay-settings.php';
	}
	...
	public function create_source( $order ) {
		...
		WC_Monilypay_Logger::log( 'Info: Begin creating Alipay source' );

		return WC_Monilypay_API::request( apply_filters( 'wc_monilypay_alipay_source', $post_data, $order ), 'sources' );
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_save = false ) {
		try {
			...
			WC_Monilypay_Logger::log( 'Info: Redirecting to Alipay...' );
