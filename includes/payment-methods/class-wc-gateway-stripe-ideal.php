 ...
 * @since 4.0.0
 */
class WC_Gateway_Monilypay_Ideal extends WC_Monilypay_Payment_Gateway {
	...
	public function __construct() {
		$this->id                 = self::ID;
		$this->method_title       = __( 'Stripe iDEAL', 'woocommerce-gateway-monilypay' );
	...
	public function init_form_fields() {
		$this->form_fields = require WC_MONILYPAY_PLUGIN_PATH . '/includes/admin/stripe-ideal-settings.php';
	}
	...
	public function process_payment( $order_id, $retry = true, $force_save_source = false ) {
		try {
			...
			WC_Monilypay_Logger::log( 'Info: Redirecting to iDEAL...' );
