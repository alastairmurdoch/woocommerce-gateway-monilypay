...
class WC_Stripe_UPE_Availability_Note {
	 ...
	 */
	const ENABLE_IN_STORE_LINK = '?page=wc-settings&tab=checkout&section=monilypay&panel=settings&highlight=enable-upe';
	...
	public static function get_note() {
		...
		$note->add_action(
			self::NOTE_NAME,
			__( 'Enable in your store', 'woocommerce-gateway-monilypay' ),
