 ...
 * @since 5.4.1
 */
class WC_Monilypay_Settings_Controller {
	/**
	 ...
	 * Constructor
	 *
	 * @param WC_Monilypay_Account $account Stripe account
	 */
	 ...
	 *
	 * @param WC_Monilypay_Payment_Gateway $gateway the Stripe gateway.
	 */
	public function admin_options( WC_Monilypay_Payment_Gateway $gateway ) {
	...
	public function admin_scripts( $hook_suffix ) {
		...
		if ( ! ( WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'monilypay' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_sepa' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_giropay' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_ideal' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_bancontact' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_eps' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_sofort' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_p24' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_alipay' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_multibanco' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_oxxo' )
			//|| WC_Monilypay_Helper::should_enqueue_in_current_tab_section( 'checkout', 'stripe_boleto' ) 
			) ) {
			return;
		}
