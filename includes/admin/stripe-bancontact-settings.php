...
return apply_filters(
	'wc_monilypay_bancontact_settings',
	[
		'geo_target'  => [
			'description' => __( 'Customer Geography: Belgium', 'woocommerce-gateway-monilypay' ),
			'type'        => 'title',
		],
		'guide'       => [
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#bancontact" target="_blank">Payment Method Guide</a>', 'woocommerce-gateway-monilypay' ),
			'type'        => 'title',
		],
		'activation'  => [
		...
		'enabled'     => [
			...
			'label'       => __( 'Enable Stripe Bancontact', 'woocommerce-gateway-monilypay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'title'       => [
			...
			'default'     => __( 'Bancontact', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'description' => [
			...
			'default'     => __( 'You will be redirected to Bancontact.', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'webhook'     => [
