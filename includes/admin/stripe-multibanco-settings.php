...
return apply_filters(
	'wc_monilypay_multibanco_settings',
	[
		'geo_target'  => [
			'description' => __( 'Customer Geography: Portugal', 'woocommerce-gateway-monilypay' ),
			'type'        => 'title',
		],
		'activation'  => [
		...
		'enabled'     => [
			...
			'label'       => __( 'Enable Stripe Multibanco', 'woocommerce-gateway-monilypay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'title'       => [
			...
			'default'     => __( 'Multibanco', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'description' => [
			...
			'default'     => __( 'You will be redirected to Multibanco.', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'webhook'     => [
