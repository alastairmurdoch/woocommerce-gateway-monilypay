...
return apply_filters(
	'wc_monilypay_giropay_settings',
	[
		'geo_target'  => [
			'description' => __( 'Customer Geography: Germany', 'woocommerce-gateway-monilypay' ),
			'type'        => 'title',
		],
		'guide'       => [
			'description' => __( '<a href="https://stripe.com/payments/payment-methods-guide#giropay" target="_blank">Payment Method Guide</a>', 'woocommerce-gateway-monilypay' ),
			'type'        => 'title',
		],
		'activation'  => [
		...
		'enabled'     => [
			...
			'label'       => __( 'Enable Stripe giropay', 'woocommerce-gateway-monilypay' ),
			'type'        => 'checkbox',
			'description' => '',
			'default'     => 'no',
		],
		'title'       => [
			...
			'default'     => __( 'giropay', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'description' => [
			...
			'default'     => __( 'You will be redirected to giropay.', 'woocommerce-gateway-monilypay' ),
			'desc_tip'    => true,
		],
		'webhook'     => [
